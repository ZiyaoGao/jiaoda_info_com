...
public class AppException extends Exception implements UncaughtExceptionHandler {
    ...
    public final static byte TYPE_ENTITY_PARSE = 0x05;
    ...
    public void saveErrorLog(Exception excp) {
        ...
        try {
            ...
            if (storageState.equals(Environment.MEDIA_MOUNTED)) {
                savePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/moudle/Log/";
    ...
    public static AppException parse(Exception e) {
        return new AppException(TYPE_ENTITY_PARSE, 0, e);
    }
