...
import com.moudle.app.BuildConfig;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/com.moudle.app/databases/";
    /*
     * //如果你想把数据库文件存放在SD卡的话 private static String DB_PATH =
     * android.os.Environment.getExternalStorageDirectory().getAbsolutePath() +
     * "/arthurcn/drivertest/packfiles/";
     */
    private static String DB_NAME = "module.db";
    private SQLiteDatabase myDataBase = null;
    private final Context myContext;

    static {
        if (BuildConfig.DEBUG) {
            DB_PATH = Environment.getExternalStorageDirectory() + File.separator + "com.moudle.app/databases/";
        }
    }
    ...
    private void copyDataBase() throws IOException {
        ...
        InputStream myInput = myContext.getResources().openRawResource(R.raw.module);
