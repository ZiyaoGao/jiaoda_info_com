...
public class FooterLoadingLayout extends LoadingLayout {
    ...
    private void init(Context context) {
        mFootContainer=(LinearLayout) findViewById(R.id.pull_to_load_footer_content);
    ...
    public void setBottomMargin(int height) {
        if (height < 0)
            return;
        LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) mFootContainer.getLayoutParams();
        lp.bottomMargin = height;
        mFootContainer.setLayoutParams(lp);
    }
