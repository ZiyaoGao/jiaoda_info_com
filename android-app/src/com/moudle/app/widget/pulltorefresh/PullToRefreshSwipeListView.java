package com.moudle.app.widget.pulltorefresh;
...
import com.moudle.app.widget.swipmenulistview.SwipeMenuListView;
 ...
 * @since 2013-8-15
 */
public class PullToRefreshSwipeListView extends PullToRefreshBase<SwipeMenuListView> implements OnScrollListener {
    /**
     * 此处需要解耦合
     */
     ...
     */
    public PullToRefreshSwipeListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void hideFooterItem() {
        if (null != mLoadMoreFooterLayout) {
            mLoadMoreFooterLayout.setState(ILoadingLayout.State.NONE);
        }
