...
/**
 * @Description 浏览器加载出错界面（包含加载状态）
 * @Author Li Chao
 * @Date 2015/12/31 15:48
 */
public class EmptyLayout extends LinearLayout {
    ...
    public void setErrorType(int i) {
        ...
        switch (i) {
            case NETWORK_ERROR:
                ...
                if (AppContext.getInstance().isNetworkConnected()) {//有网络，但是加载出错
                    tv.setText(R.string.error_view_load_error_click_to_refresh);
                    img.setBackgroundResource(R.drawable.my_img_nozd);
                } else {//无网络导致加载出错
                    tv.setText(R.string.network_not_connected);
                    img.setBackgroundResource(R.drawable.my_img_nozd);
                }
            ...
            case NODATA_ENABLE_CLICK:
                ...
                animProgress.setVisibility(View.GONE);
                img.setImageResource(R.drawable.my_img_nozd);
    ...
    public void setTvNoDataContent() {
        if (!strNoDataContent.equals(""))
            ...
            tv.setText(R.string.load_empty);
    }
